...
# old way to collect data in windows
# class JSONLogger:
...
#         for file_path in [self.data_log, self.anomaly_log]:
...
#         }
#         self._append_to_json(self.data_log, entry)
#
#     def log_anomaly(self, timestamp: float, window_start: int, window_end: int,confidence: float, first_anomaly_index : int = None):
#         entry = {
#             "timestamp": timestamp,
#             "window_start": window_start,
#             "window_end": window_end,
