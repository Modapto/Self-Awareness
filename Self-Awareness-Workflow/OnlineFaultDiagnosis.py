...
class OnlineFaultDiagnoser:
    ...
    #                 }
    #
    #         fault_predictions = [pred['prediction'] for pred in sample_predictions.values()]
    #         fault_confidence = sum(fault_predictions) / len(fault_predictions)
    #
    #         fault_type = 1 if fault_confidence > 0.5 else "Normal"
    #         confidence = fault_confidence if fault_confidence > 0.5 else 1 - fault_confidence
    #
    #         # Save checkpoint
